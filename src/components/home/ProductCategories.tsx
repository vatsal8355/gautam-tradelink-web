...
const categories = [
  {
    ...
    examples: ["Azythromycin", "Paracetamol", "Metformin HCl"],
  ...
  },
  {
    ...
    examples: ["Microcrystalline Cellulose", "Lactose Monohydrate", "Povidone (PVP)"],
  ...
  },
  {
    ...
    examples: ["Vitamin A", "Coenzyme Q10", "Green Tea Extract"],
